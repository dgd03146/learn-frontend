...
function App() {
  ...
  const rowVirtualizer = useVirtual({
    size: items.length, // size of our list. virtual list we are going to make
    parentRef: listRef, // parent
    estimateSize: React.useCallback(() => 20, []), // memoized function 20height
    overscan: 10, // how many rows above and below
  })
